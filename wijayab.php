...
echo color("white"," ---------SEMOGA BERHASIL NI CODE ----------\n");
echo color("blue","  [♥]  Time  : ".date('[d-m-Y] [H:i:s]')."   \n");
echo color("purple","[♥] NGETIK NOMORNYA BEGINI YA 62xxxxxxxxxx \n");
echo color("nevy","  [♡] JANGAN LUPA FOLLOW IG GUE YA : @firmangultom\n");
...
echo color("green","# # # # # # # # # # # # # # # # # # # # # # # \n");
	echo "\n";
echo "\e[92m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
echo "\e[93m PUNYA AKUN BUAT LOGIN ?: ";	
...
// function change(){
        ...
        echo color("yellow","📲▶️ TULIS NOMERMU !! : ");
        // $no = trim(fgets(STDIN));
        ...
        echo "\n".color("red","🔐▶️ INI BUAT MAKAN PENGEMIS DAN KAMU");
	...
	gocar:
        ...
        $message = fetch_value($code1,'"message":"','"');
        echo "\n".color("red","🔓▶️ Message: ".$message);
        echo "\n".color("yellow","🔐▶️ INI MAKANMU LUR");
        echo "\n".color("green","⏳▶️ Please wait");
        for($a=1;$a<=3;$a++){
        echo color("white",".");
        sleep(15);
